...
def predict():
    ...
    lang_code = data.get("lang", "en")  # Get dropdown value
    ...
    try:
        ...
        return jsonify({"reply": f"⚠️ Translation Error. Fallback to English:\n\n{ai_response}"})

if __name__ == '__main__':
    # Cloud-ready Configuration (Using os.environ for PORT)
